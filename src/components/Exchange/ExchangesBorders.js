...
export const ExchangesBorders = () => {
    const france = useFetchData('intercambios', 'francia-frontera', 'year')
    const portugal = useFetchData('intercambios', 'portugal-frontera', 'year')
    const morocco = useFetchData('intercambios', 'marruecos-frontera', 'year')
    const andorra = useFetchData('intercambios', 'andorra-frontera', 'year')
    ...
    return (
        <>
            <h3 className='d-flex justify-content-center'>Intercambios</h3>
            {
